...
(function () {
  var DeprecatedGlobbingBehavior,
    NodeTypes,
    ParameterMissing,
    ReservedOptions,
    SpecialOptionsKey,
    UriEncoderSegmentRegex,
    Utils,
    result,
    root,
  ...
  Utils = {
    ...
    make: function () {
      ...
      routes = {
        ...
        // function(options)
        apiV1TasksShowPath: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        newDeveloperPath: Utils.route([["format", false]], {}, [
          2,
          [7, "/", false],
          [
            2,
        ...
        // function(options)
        newRailsConductorInboundEmailPath: Utils.route(
          [["format", false]],
          {},
          [
            2,
